...
export default function Home() {
  const slides = [
    {
      ...
      title: (
        <>
          Yönetim Cebinizde.<br />
          <span className="text-indigo-600">Anlık Veri, Tam Kontrol.</span>
        </>
      ),
      desc: "İşletmenizi her yerden takip edin. Mobil yazılımımız ile üretimden satışa tüm süreçleri anlık izleyin, anında müdahale edin.",
      link: "/mobil",
    },
    {
      image: "/images/desktop.png",
      tag: "Masaüstü Yazılım",
      title: (
        <>
          Güçlü Altyapı.<br />
          <span className="text-indigo-600">Sınırsız Raporlama.</span>
        </>
      ),
      desc: "Kapsamlı analizler, otomatik raporlar ve entegrasyonlarla verimliliği maksimize edin. Büyük veriyi anlamlı aksiyona dönüştürün.",
      link: "/masaustu",
    },
    {
      image: "/images/laser-cutting.jpg",
      tag: "Lazer Kesim Teknolojisi",
      title: (
        <>
          Hassas Kesim.<br />
          <span className="text-indigo-600">Mükemmel Sonuç.</span>
        </>
      ),
      desc: "Endüstriyel lazer kesim makinelerimizle projelerinizi en ince detayına kadar hayata geçirin. Hızlı, güvenilir ve yüksek kalite.",
      link: "/lazer-kesim",
    },
  ];

  // Apple‑style feature data
  const features = [
    {
      icon: (
      ...
      title: "7/24 Destek",
      desc: "Her an yanınızda, canlı destek ve uzman ekibimizle kesintisiz hizmet.",
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "0.05mm Hassasiyet",
      desc: "Lazer kesim ve üretim süreçlerinde mikron seviyesinde doğruluk.",
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Sorunsuz Kalite",
      desc: "ISO belgeli süreçlerle sıfır hata hedefi, %100 müşteri memnuniyeti.",
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      desc: "Stoktan hızlı sevkiyat ve proje bazlı zamanında teslimat garantisi.",
    },
  ];
  ...
  const steps = [
    {
      ...
      desc: "Mühendislerimiz projenizi teknik olarak inceler ve en verimli yöntemi belirler.",
    },
    {
      num: "02",
      title: "Stratejik Planlama",
      desc: "Yazılım mimarisi veya üretim simülasyonları ile riskler minimize edilir.",
    },
    {
      num: "03",
      title: "Kusursuz Uygulama",
      desc: "Son teknoloji parkurumuzda veya geliştirme ortamımızda projeniz hayat bulur.",
    },
  ];
  ...
  return (
    <main className="flex flex-col items-center overflow-x-hidden bg-white">
      {/* Carousel */}
      <HeroCarousel slides={slides} brandColor="#4f46e5" />
        ...
        <div className="container relative mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-5xl md:text-6xl font-semibold tracking-tight text-gray-900 leading-[1.1]">
              Neden <span className="text-indigo-600 relative inline-block">
                Sezkon?
            ...
            <p className="mt-6 text-xl text-gray-500 font-light leading-relaxed">
              Mükemmelliği standartlarımızın ötesine taşıyoruz.
            </p>
          </div>
      ...
      {/* DUAL EXPERTISE – Apple‑Style Cards */}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Sezkon, sanayinin fiziksel gücünü dijitalin zekasıyla harmanlayarak işletmenizi geleceğe hazırlar.
            </p>
          </div>

          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {/* CNC Service Card – Apple Style */}
            <div className="group relative bg-white/70 backdrop-blur-sm rounded-3xl p-8 lg:p-10 transition-all duration-500 hover:shadow-2xl hover:bg-white/90 border border-gray-100 hover:border-indigo-200">
              <div className="flex flex-col h-full">
                ...
                <p className="text-gray-600 leading-relaxed mb-6 text-lg font-light">
                  Yüksek hassasiyetli CNC işleme merkezlerimiz ile savunma sanayi, havacılık ve makine sektörüne özel parçalar üretiyoruz.
                </p>
                <ul className="space-y-3 mb-8">
                  {["5 Eksen İşleme Merkezi", "Yüksek Hızlı Frezeleme", "Savunma Sanayi Standartları"].map(
                    (item, i) => (
            ...
            {/* Software Service Card – Apple Style (dark version) */}
            <div className="group relative bg-indigo-950/90 backdrop-blur-sm rounded-3xl p-8 lg:p-10 transition-all duration-500 hover:shadow-2xl hover:bg-indigo-950 border border-indigo-800/50 hover:border-indigo-600">
              <div className="flex flex-col h-full">
                ...
                <p className="text-indigo-200/80 leading-relaxed mb-6 text-lg font-light">
                  İş süreçlerinizi dijitalleştiren, verimliliği artıran ve karar alma mekanizmalarınızı güçlendiren özel yazılımlar geliştiriyoruz.
                </p>
                <ul className="space-y-3 mb-8">
                  {["Özel ERP & CRM Çözümleri", "Endüstri 4.0 Entegrasyon", "Gerçek Zamanlı Veri Analitiği"].map(
                    (item, i) => (
      ...
      {/* OPERATIONAL PROCESS – Apple‑Style */}
      ...
      {/* CTA SECTION – Apple‑Style Premium */}
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-8 text-left">
                ...
                <h2 className="text-4xl lg:text-6xl font-black text-white tracking-tighter leading-tight italic">
                  Geleceği Şekillendirmeye <br />{" "}
                  <span className="text-indigo-400">Bugünden</span> Başlayın.
                </h2>
                <p className="text-lg text-indigo-100/80 max-w-xl">
                  Mühendislik zorluklarınıza modern ve teknolojik çözümler getirmek için sadece bir tık uzağınızdayız.
                </p>
              </div>
              <div className="flex flex-col gap-4 items-start md:items-end">
                ...
                <div className="flex items-center gap-4 text-white/60 text-sm italic font-medium px-4">
                  <Shield size={16} /> 24 Saat İçinde Teknik Teklif
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Final bottom section – Striking & Animated (heading only) */}
