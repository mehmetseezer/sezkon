...
export const metadata: Metadata = {
  title: 'Blog | Sezkon – Teknoloji, Üretim ve Yazılım İçerikleri',
  description: 'CNC üretim teknolojileri, yazılım geliştirme, Endüstri 4.0 ve yapay zeka konularında uzman görüşleri.',
  keywords: ['Sezkon blog', 'CNC teknoloji', 'yazılım geliştirme', 'Endüstri 4.0'],
  openGraph: {
    title: 'Blog | Sezkon',
    description: 'Teknoloji, üretim ve yazılım dünyasından uzman içerikler.',
    type: 'website',
  },
};
    ...
    <main className="flex flex-col items-center overflow-x-hidden bg-white">
      ...
      <section className="w-full pt-36 pb-16 bg-gradient-to-b from-neutral-50 to-white relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-6 max-w-5xl text-center">
          <div className="inline-flex items-center rounded-full bg-indigo-50 px-4 py-1 text-sm font-semibold text-indigo-600 italic mb-6">Sezkon Blog</div>
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-gray-900 leading-[1.05] mb-8">
            Teknoloji &{' '}
            <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Üretim</span>{' '}Dünyasından
          </h1>
          <p className="text-xl text-gray-500 font-light leading-relaxed max-w-3xl mx-auto">
            Endüstri 4.0, yapay zeka, CNC teknolojileri ve yazılım geliştirme üzerine uzman görüşleri.
          </p>
        </div>
      </section>
          ...
          <div className="group relative bg-indigo-950/90 rounded-3xl p-10 lg:p-16 overflow-hidden hover:shadow-2xl transition-all duration-500 cursor-pointer">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                <span className="text-[11px] font-bold uppercase tracking-widest bg-white/10 text-white px-3 py-1 rounded-full border border-white/20">Öne Çıkan</span>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="text-center mt-16">
            <button className="inline-flex items-center gap-3 px-10 py-4 border-2 border-gray-200 text-gray-700 font-semibold rounded-full hover:border-indigo-400 hover:text-indigo-600 transition-all duration-300">
              Daha Fazla Makale <ArrowRight size={18} />
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-24 bg-gradient-to-b from-neutral-50 to-white relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-6 max-w-3xl text-center">
          <div className="inline-flex items-center rounded-full bg-indigo-50 px-4 py-1 text-sm font-semibold text-indigo-600 italic mb-6">Bülten</div>
          <h2 className="text-4xl lg:text-5xl font-black tracking-tighter text-gray-900 mb-6">
            Gelişmeleri{' '}
            <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Kaçırmayın</span>
          </h2>
          <p className="text-gray-500 font-light mb-10 text-lg">Ayda bir, özenle seçilmiş teknoloji ve üretim içerikleri e-posta kutunuzda.</p>
          <div className="flex gap-3 max-w-md mx-auto">
            <input type="email" placeholder="E-posta adresiniz" className="flex-1 px-6 py-4 rounded-full border border-gray-200 focus:outline-none focus:border-indigo-400 text-gray-800 font-medium" />
            <button className="px-8 py-4 bg-indigo-600 text-white font-semibold rounded-full hover:bg-indigo-700 transition-colors whitespace-nowrap">Abone Ol</button>
          </div>
        </div>
      </section>
    </main>
