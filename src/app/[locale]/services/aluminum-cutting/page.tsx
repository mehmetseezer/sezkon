...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const path = '/services/aluminum-cutting'; // her iki dilde de aynı yol
...
const materials = [
  '1000 Serisi (Saf Alüminyum)', '2000 Serisi (Havacılık)', '5000 Serisi (Marine)',
  '6000 Serisi (Yapısal)', '7000 Serisi (Yüksek Mukavemet)', 'Alüminyum Kompozit Panel'
];
