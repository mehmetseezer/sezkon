...
const getFeatures = (t: any) => [
  { icon: Smartphone, title: t('f1_t'), desc: t('f1_d') },
  { icon: Bell, title: t('f2_t'), desc: t('f2_d') },
  { icon: BarChart2, title: t('f3_t'), desc: t('f3_d') },
  { icon: Lock, title: t('f4_t'), desc: t('f4_d') },
  { icon: Zap, title: t('f5_t'), desc: t('f5_d') },
  { icon: BarChart2, title: t('f6_t'), desc: t('f6_d') },
];
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl font-black tracking-tighter text-gray-900">
              {t('sec_t1')} <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">{t('sec_t2')}</span> {t('sec_t3')}
            </h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {(t.raw('cases') as string[]).map((uc, i) => (
          ...
          <div className="relative bg-indigo-950 rounded-[3rem] p-12 lg:p-20 overflow-hidden shadow-2xl text-center">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl lg:text-5xl font-black text-white tracking-tighter italic mb-6">
                {t('cta_t1')} <span className="text-indigo-400">{t('cta_t2')}</span> {t('cta_t3')}
              </h2>
